...
{
    public class GetByCodigoProjeto
    {

        private readonly ProductClientHubDbContext _context;
        public GetByCodigoProjeto(ProductClientHubDbContext context)
        {
            _context = context;
        }

        public ResponseProjetoJson Execute(String codigo)
        {
            ...
            var entity = _context
                .Projeto
                .Include(p => p.Usuario)
                .FirstOrDefault(projeto => projeto.Codigo == codigo);
